...
main:
        ...
        sll     $10, $7, 2      # This is equivalent to multiplying $7 by 4.

        addu    $10, $10, $7    # Adds $7 to $10. This adds x back to 4x.

        sll     $10, $10, 1     # This multiplies 4x+x by 2. So $10 holds 8x+2x.

        addu    $10, $10, $7    # Adds $7 to $10. This adds x back to 8x+2x.

        sll     $10, $10, 1     # This multiplies 8x+2x+x by 2. So $10 holds
                                # 16x+4x+2x.

        addu    $10, $10, $7    # This adds x back to 16x+4x+2x. So $10 holds 
                                # 16x+4x+2x+x which equals 23x.
